...
class gsp_algarDePara_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(7)
invokeTag('image','asset',21,['src':("grails_logo.png"),'alt':("Accenture")],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1471965570157L
