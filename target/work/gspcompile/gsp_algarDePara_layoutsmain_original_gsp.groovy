...
class gsp_algarDePara_layoutsmain_original_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/main_original.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',20,['controller':("tipoInformacao"),'action':("index")],2)
printHtmlPart(8)
createClosureForHtmlPart(9, 2)
invokeTag('link','g',21,['controller':("integracao"),'action':("index")],2)
printHtmlPart(10)
})
...
createTagBody(1, {->
printHtmlPart(12)
invokeTag('image','asset',29,['src':("grails_logo.png"),'alt':("Accenture")],-1)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1472585036461L
