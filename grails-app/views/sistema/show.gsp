	...
	<body>
		...
		<div id="show-sistema" class="content scaffold-show" role="main">
			...
			<ol class="property-list sistema">
				...
				<g:if test="${sistemaInstance?.nome}">
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="sistema.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${sistemaInstance}" field="nome"/></span>
