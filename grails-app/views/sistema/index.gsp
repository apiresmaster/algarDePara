		...
		<div id="list-sistema" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'sistema.nome.label', default: 'Nome')}" />
				...
				<g:each in="${sistemaInstanceList}" status="i" var="sistemaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${sistemaInstance.id}">${fieldValue(bean: sistemaInstance, field: "nome")}</g:link></td>
