...
<html>
	...
	<body>
		<a href="#show-tipoInformacao" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-tipoInformacao" class="content scaffold-show" role="main">
			...
			<ol class="property-list tipoInformacao">
				...
				<g:if test="${tipoInformacaoInstance?.data}">
				<li class="fieldcontain">
					<span id="data-label" class="property-label"><g:message code="tipoInformacao.data.label" default="Data" /></span>
					
						<span class="property-value" aria-labelledby="data-label"><g:formatDate date="${tipoInformacaoInstance?.data}" /></span>
